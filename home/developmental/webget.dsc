...
webget_discordcommand_handler:
  ...
  data:
    help_args:
      ...
      headers:
        name: (data/parsed_data<&co><&lt>data<&gt>)
        value: Headers to submit to the server; Uses format<&co> `key=value;...`
      timeout:
