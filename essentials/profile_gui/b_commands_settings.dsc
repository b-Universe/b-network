b_commands_settings_menu_handler:
  type: world
  debug: false
  events:
    on player clicks b_commands_settings_button in !b_commands_settings_menu:
      - inventory open d:b_commands_settings_menu
      - playsound <player> entity_player_levelup pitch:<util.random.decimal[0.8].to[1.2]> volume:0.3 if:<player.has_flag[behr.essentials.settings.playsounds]>

    on player clicks settings_* in b_commands_settings_menu:
...
settings_commands_playsound:
  ...
  lore:
    - <&2><strikethrough><proc[sp].context[53]><&2><&lc> <&a>Enabled <&2><&rc><strikethrough><proc[sp].context[53]>
    - <&color[<proc[argb]>]>Changes whether or not you
    - <&color[<proc[argb]>]>hear command and menu sounds
    - <&6>*<&8>Excludes bEdit
    - <&2><strikethrough><proc[sp].context[162]>
  data:
    disabled_lore:
      - <&4><strikethrough><bold><proc[sp].context[48]><&4><bold><&lc> <&c>Disabled <&4><bold><&rc><bold><strikethrough><proc[sp].context[49]>
      - <&color[<proc[argb]>]>Changes whether or not you
      - <&color[<proc[argb]>]>hear command and menu sounds
      - <&6>*<&8>Excludes bEdit
      - <&4><strikethrough><bold><proc[sp].context[160]>
  mechanisms:
    hides: all
