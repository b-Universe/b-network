world_command:
  ...
  tag_data:
    valid_folders: <util.list_files[../../].filter_tag[<util.list_files[../../<[filter_value]>].contains[level.dat].if_null[false]>]>
  tab complete:
        ...
        - choose <[world_name]>:
          ...
          - case list_unloaded:
            ...
            - foreach <[unloaded_worlds]> as:world_name:
              ...
              - define world_list <[world_list].include_single[<&b><&lb><[text].on_hover[<[hover].on_click[/<[command]>]>]><&b><&rb>]>

            - narrate "<&[green]>Unloaded worlds (<[unloaded_worlds].size>)<&co><n><[world_list].separated_by[<&a>, ]>"
        ...
        - choose <context.args.first>:
          ...
          - case destroy:
            ...
            - if !<player.has_flag[behrry.essentials.world.prompt.destroy.0]>:
              ...
              - define accept <[text].on_hover[<[hover]>].on_click[<[command]>]>
