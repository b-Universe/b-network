tag_command_create:
  ...
  script:
    ...
    - ~discordcommand id:c create options:<[options]> name:tag "Description:Parse a tag" group:901618453356630046
    - ~discordcommand id:c create options:<[options]> name:parse "Description:Parse a tag" group:901618453356630046
